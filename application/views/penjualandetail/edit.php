...
<div class="mb-3">
    ...
    <input type="number" name="harga_mobil" class="form-control" id="exampleFormControlInput1" placeholder="merk" value="<?= $mobil['harga_mobil'] ?>">
</div>
<div class="mb-3">
    <label for="exampleFormControlInput1" class="form-label">Stok Unit</label>
    <input type="number" name="stok_unit" class="form-control" id="exampleFormControlInput1" placeholder="stok mobil" value="<?= $mobil['stok_unit'] ?>">
</div>
<div class="mb-3">
