  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
		...
		<li class="nav-item">
          <a class="nav-link" href="#">Mobil Masuk</a>
        </li>
      </ul>
...
<div class="row mt-2">
	<div class="col-3">
	<a href="<?=base_url('mobil');?>" class="btn btn-success">Tambah</button></a>
	</div>
</div>
<table class="table mt-2">
  <thead>
    <tr>
      ...
      <th scope="col">Stok Unit</th>
      <th scope="col">Keterangan</th>
    </tr>
  </thead>
  <tbody>
	  <?php
		foreach($allmobil as $no=>$mobil){
	  ?>
	<tr>
